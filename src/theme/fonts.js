...
export default {
  ...
  h3: { ...base, size: base.size * 1.20, lineHeight: lineHeight(base.size * 1.5) },
  ...
  t12: { ...base, size: base.size * 0.80, lineHeight: lineHeight(base.size * 0.9) },
  t14: { ...base, size: base.size, lineHeight: lineHeight(base.size * 1.1) },
  t16: { ...base, size: base.size * 1.15, lineHeight: lineHeight(base.size * 1.20) },
